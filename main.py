...
simulationTime = 200e-9 # total simulation time (s)
rightReflectivity = 0.99 # reflectivity of the right mirror
current = 0.070 # current fed to the amplifier sections
...
filter = []
is_fullOutput = True    # boolean to switch for recording at multiple locations in the laser structure
